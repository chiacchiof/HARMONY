...
toc`;
      ...
      return template
        ...
        .replace(/<PERC_ERR_TOLERANCE>/g, ((config.percentageErrorTollerance || 5.0) / 100).toString())
        .replace(/<PERCENTAGE_ERROR_TOLLERANCE>/g, ((config.percentageErrorTollerance || 5.0) / 100).toString())
